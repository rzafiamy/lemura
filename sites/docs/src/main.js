...
const docs = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'tools-and-skills/tool-firewall', title: 'Tool Firewall', file: 'tools-and-skills/tool-firewall.md', icon: 'shield' },
  ...
  },
  {
    id: 'media-bridge',
    title: 'Media Bridge',
    subtitle: 'ASR, TTS, vision, and image generation for any app',
    file: 'media-bridge.md',
    icon: 'radio',
    color: 'primary',
    category: 'Fundamentals',
    children: [
      { id: 'media-bridge/asr-transcription', title: 'ASR & Transcription', file: 'media-bridge/asr-transcription.md', icon: 'radio' },
      { id: 'media-bridge/tts-synthesis', title: 'TTS & Synthesis', file: 'media-bridge/tts-synthesis.md', icon: 'play' },
      { id: 'media-bridge/vision-description', title: 'Vision & Description', file: 'media-bridge/vision-description.md', icon: 'search' },
      { id: 'media-bridge/image-generation', title: 'Image Generation', file: 'media-bridge/image-generation.md', icon: 'box' },
      { id: 'media-bridge/bridge-orchestration', title: 'Bridge Orchestration', file: 'media-bridge/bridge-orchestration.md', icon: 'activity' },
    ],
  },
  {
    id: 'rag-integration',
  ...
  {
    id: 'session-config',
    title: 'SessionConfig Reference',
    subtitle: 'Deep dive into every configuration property and policy',
    file: 'session-config.md',
    icon: 'settings',
    color: 'purple',
    category: 'Reference',
    children: [
      { id: 'session-config/core-adapter-settings', title: 'Core & Adapter', file: 'session-config/core-adapter-settings.md', icon: 'cpu' },
      { id: 'session-config/execution-loop-settings', title: 'Execution & Loop', file: 'session-config/execution-loop-settings.md', icon: 'activity' },
      { id: 'session-config/context-memory-settings', title: 'Context & Memory', file: 'session-config/context-memory-settings.md', icon: 'layers' },
      { id: 'session-config/tools-media-settings', title: 'Tools & Media', file: 'session-config/tools-media-settings.md', icon: 'tool' },
      { id: 'session-config/security-logging-settings', title: 'Security & Logging', file: 'session-config/security-logging-settings.md', icon: 'shield' },
    ],
  },
  {
